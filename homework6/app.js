...
app.post('/questionadd', function(req, res) {
    ...
    if((dollarValue % 100 )%2 !=0 || dollarValue<100 || dollarValue>2000){
        errFlag = true;
    ...
    db.all(authQuery, function(err, rows) {
        ...
        if (rows) {
            ...
            if( timeDifferent>360000) {
                ...
                var checkquery1 = "select CategoryTitle from Categories"+
                ...
                var checkquery2 = "select CategoryCode from Categories"+
                    " WHERE categoryCode = "+ categoryCode +" AND categoryTitle !=" + " '"+categoryTitle+"'";
