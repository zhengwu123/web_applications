...
function body_onload() {
    ...
    function signInSuccess() {
        ...
        //getEntries(sortEntries(displayEntries()));
        //alert(gEntries);
        //sortEntries();
       // displayEntries();
            getEntries();
    ...
    function sortEntries() {
        ...
        var sortColumn = localStorageGet("sortColumn", "1");
        var sortAscDesc = localStorageGet("sortAscDesc", "a");
        var localEntrys = JSON.parse(localStorageGet("Entries",null));
        localEntrys.sort(entriesCompare);
        sortSetHeadings();
        return;
    ...
    function displayEntries() {
        ...
        //
        gEntries = JSON.parse(localStorageGet("Entries",null));
